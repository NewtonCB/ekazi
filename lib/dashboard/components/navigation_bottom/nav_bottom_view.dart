  ...
  Widget build(BuildContext context) {
    return Obx(
        ...
        items: [
          ...
          _buildBottomNavyBarItem(Icons.bookmark, 'Saved', controller.selectedIndex.value == 1),
          _buildBottomNavyBarItem(Icons.favorite, 'Favourite', controller.selectedIndex.value == 2),
          _buildBottomNavyBarItem(Icons.settings, 'Settings', controller.selectedIndex.value == 3),
        ],
      ),
    );
  }
